@echo off
REM VPS Deployment Script for Exped360 Backend (Windows)
REM This script helps you prepare files for VPS deployment

echo 🚀 Preparing Exped360 Backend for VPS deployment...
...
copy tsconfig.build.json deploy-package\
copy nest-cli.json deploy-package\
...
echo - Edit .env file with your actual configuration
