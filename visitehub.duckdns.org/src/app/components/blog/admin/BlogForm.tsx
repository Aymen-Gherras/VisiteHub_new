  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        ...
        <div className="mt-4">
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Extrait * <span className="text-xs text-gray-500 font-normal"></span>
          </label>
          <textarea
            name="excerpt"
        ...
        <div className="mt-4">
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Contenu * <span className="text-xs text-gray-500 font-normal">(Éditeur de texte enrichi avec aperçu en direct)</span>
          </label>
          <RichTextEditor
            ...
            placeholder="Rédigez votre article ici... Utilisez les outils de formatage pour créer un contenu riche et optimisé pour le SEO."
          />
        </div>
