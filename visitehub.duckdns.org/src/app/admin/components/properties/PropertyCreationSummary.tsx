    ...
    <div className="space-y-8">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div><span className="font-medium">Prix:</span> {data.basicInfo.price ? (typeof data.basicInfo.price === 'number' ? data.basicInfo.price.toLocaleString('fr-FR') : data.basicInfo.price) : 'Non spécifié'}</div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div><span className="font-medium">Apport initial:</span> {data.financing.downPayment ? (typeof data.financing.downPayment === 'number' ? data.financing.downPayment.toLocaleString('fr-FR') : data.financing.downPayment) : 'Non spécifié'}</div>
          {data.financing.monthlyPayment > 0 && (
            <div><span className="font-medium">Mensualité:</span> {typeof data.financing.monthlyPayment === 'number' ? data.financing.monthlyPayment.toLocaleString('fr-FR') : data.financing.monthlyPayment}</div>
          )}
        </div>
      </div>
