...
export default function ContactSection({ agenceData, setAgenceData, onNext, onPrevious }: ContactSectionProps) {
  const [website, setWebsite] = useState(agenceData.website || '');
  const [phone, setPhone] = useState(agenceData.phone || '');
  const [email, setEmail] = useState(agenceData.email || '');
  const [address, setAddress] = useState(agenceData.address || '');
  const [wilaya, setWilaya] = useState(agenceData.wilaya || '');
  const [daira, setDaira] = useState(agenceData.daira || '');
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <input
          ...
          placeholder="https://www.agency.dz"
          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Enter the agency's main office address"
          rows={3}
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-700">
              Provide at least one contact method. This information will be displayed on the agency profile 
              page to help potential clients get in touch with your services.
            </p>
          </div>
        </div>
      </div>
