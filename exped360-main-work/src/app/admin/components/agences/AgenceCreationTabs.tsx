...
interface AgenceCreationTabsProps {
  activeTab: string;
...
const tabs = [
  { id: 'basic-info', label: 'Basic Information', icon: '🏢', description: 'Agency name and description' },
...
export default function AgenceCreationTabs({
  activeTab,
  setActiveTab,
  agenceData,
  setAgenceData,
      ...
      case 'images':
        return (
          <ImagesSection
            ...
            setAgenceData={setAgenceData}
            onPrevious={handlePrevious}
            onAgenceCreated={onAgenceCreated}
