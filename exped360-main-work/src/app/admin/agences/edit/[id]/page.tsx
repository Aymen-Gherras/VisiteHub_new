...
export default function EditAgence({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const initializeAgence = async () => {
      try {
        const resolvedParams = await params;
        setAgenceId(resolvedParams.id);
        
        setLoading(true);
        setError(null);
        const data = await apiService.getAgence(resolvedParams.id);
        setAgenceData(data);
      } catch (err) {
  ...
  const handleAgenceUpdated = (agence: Agence) => {
      ...
      <div className="max-w-4xl mx-auto py-8">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">Error loading agence</h3>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Update agence information and details
              </p>
            </div>
            <button
        ...
        <AgenceCreationTabs
          ...
          onAgenceCreated={handleAgenceUpdated}
          isEditing={true}
          agenceId={agenceId}
          token={token || ''}
        />
